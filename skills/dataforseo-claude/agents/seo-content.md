...
1. Pull what the target ranks for and who its competitors are:
   ...
   /paperclip/dataforseo-claude/scripts/domain_overview.py competitors --target <domain> --limit 5
   ```
2. Pull the content gap vs. the top 3 competitors:
   ```bash
   /paperclip/dataforseo-claude/scripts/domain_overview.py content_gap --you <domain> --competitors <c1> <c2> <c3>
   ```

...
A simple file-based watchlist at `/paperclip/dataforseo-claude/output/watchlist.json`.
...
```bash
/paperclip/dataforseo-claude/scripts/serp_check.py rank --domain <domain> --keywords <kw...>
```

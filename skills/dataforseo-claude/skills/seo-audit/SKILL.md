...
> **Cost:** ~$0.10-0.30 per full audit · **Setup:** add credentials to `/paperclip/dataforseo-claude/.env`
...
Match this shape (see `/paperclip/dataforseo-claude/schema/audit_input.example.json`):
...
Save to: `/paperclip/dataforseo-claude/output/<domain>-audit.json`

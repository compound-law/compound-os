...
```bash
/paperclip/dataforseo-claude/scripts/domain_overview.py overview --target <d1>
/paperclip/dataforseo-claude/scripts/domain_overview.py overview --target <d2>
/paperclip/dataforseo-claude/scripts/backlinks.py summary --target <d1>
/paperclip/dataforseo-claude/scripts/backlinks.py summary --target <d2>
/paperclip/dataforseo-claude/scripts/domain_overview.py intersect --you <d1> --competitor <d2> --limit 100
```

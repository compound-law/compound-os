...
```bash
/paperclip/dataforseo-claude/scripts/serp_check.py rank --domain <domain> --keywords kw1 kw2 kw3 ...
```
...
```bash
/paperclip/dataforseo-claude/scripts/keyword_research.py volume kw1 kw2 kw3 ...
```
